...
if($_POST){
  ...
  $entidadUsuario->obtenerPorUsuario($usuario); 
	...
	if($entidadUsuario->verificarClave($contrasenia, $entidadUsuario->contrasenia)){
            ...
            <div class="card-body p-0">
                ...
                <div class="col-lg-6">
                    ...
                    <?php endif; ?>
                        ...
                        <input type="text" class="form-control form-control-user" id="txtusuario" name="txtUsuario" aria-describedby="emailHelp" placeholder="Usuario" value="" minlength="5" maxlength="15" require>
                        </div>
                        <div class="form-group">
                        <input type="password" class="form-control form-control-user" id="txtContrasenia" name="txtContrasenia" placeholder="Clave" value="" require>
                        </div>
                        <div class="form-group">
                    ...
                    <hr>
                    <div class="text-center">
                        <a class="small" href="recuperarcontrasenia.php">Olvidaste la clave?</a>
                    </div>
                    <div class="text-center">
